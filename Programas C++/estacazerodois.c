...
int main ()
{
	...
	media = sala/160;
	   ...
	   printf("Seu salario, sem desconto, e de: %2.2f reais",toma);
	   ...
	   printf("Seu salario, apos o desconto do inss e de: %2.2f reais",celeta);
	   printf("foram descontados %2.2f reais",inss);
	   return 0;
